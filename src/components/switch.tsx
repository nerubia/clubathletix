...
const colors = {
  ...
  blue: [
    ...
    '[--switch:white] [--switch-ring:var(--color-slate-700)]/90 [--switch-shadow:var(--color-slate-900)]/20',
  ],
  indigo: [
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Focus
        'focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-slate-500',
        // Hover
