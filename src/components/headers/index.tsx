        ...
        <div className="relative isolate">
          ...
          <div className="overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-30 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex md:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-lg lg:shrink-0 xl:max-w-xl">
                  ...
                  <p className="mt-8 pr-4 font-medium text-pretty text-gray-500 sm:max-w-md lg:text-xl/8 lg:max-w-none">
                    Led by a seasoned professional athlete with extensive international training and pro sports experience, 
                    our dynamic program offers a holistic approach to skill enhancement, fitness development, and mental resilience. 
                    Through personalized coaching, tailored workouts, and mentorship, participants will gain invaluable insights, 
                    honing their athletic prowess while cultivating essential life skills for success both on and off the field. 
                ...
                <div className="mt-14 flex justify-end gap-8 sm:-mt-72 sm:justify-start sm:pl-60 lg:mt-0 lg:pl-0">
                  ...
                  <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 pt-40 sm:pt-52 lg:pt-36">
                    <div className="relative">
