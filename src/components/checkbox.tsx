...
export function CheckboxField({
  className,
  ...props
}: { className?: string; 'data-theme'?: 'light' | 'dark' } & Omit<Headless.FieldProps, 'as' | 'className'>) {
  return (
    <Headless.Field
      data-slot="field"
      {...props}
...
const base = [
  ...
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-slate-500',
  // Disabled state
...
const colors = {
  ...
  blue: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-slate-600)] [--checkbox-checked-border:var(--color-slate-700)]/90',
  indigo:
...
export function Checkbox({
  ...
  return (
    ...
    >
      <span className={clsx([base, props['data-theme'] !== 'light' && darkBase, colors[color]])}>
        <svg
