...
export default function ParentalExpectationsPage() {
  return (<section className='relative max-w-7xl mx-auto'>
    <div className="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 md:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10 lg:max-w-7xl">
            ...
            <div className="-mt-12 lg:py-12 lg:px-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden text-zinc-700">
                <img
                    alt=""
            ...
            <div className="lg:col-span-1 lg:col-start-1 lg:row-start-2 space-y-8 lg:mx-auto lg:grid lg:w-full grid-cols-2 lg:grid-cols-1 lg:gap-x-8 lg:gap-y-8 lg:px-8">
                <div className="lg:pr-4 text-base/7 text-gray-700">
