...
const tiers = [
	{
		...
		features: [
			'Goalie moments (saves / assists)',
			'Defensive moments (successful tackles)',
			'Midfielders moments (crosses, passes, successful plays)',
			'Attackers moments (goals, assists, crosses)',
			'View your video 4 - 12 hours after the match.*',
		],
	},
	{
		...
		unit: '/5 matches',
		description:
			'Perfect for college recruitment or personal keepsakes, we create highlight compilations of 5 of your best matches.',
		features: [
					...
					<div className="mx-auto max-w-7xl px-6 lg:px-8">
						<div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2">
							{tiers.map((tier) => (
								<div
									key={tier.id}
									className={`flex rounded-3xl bg-white shadow-xl ring-1 ring-gray-900/10 ${tier.id === 'playerevoplus' ? 'col-span-2' : 'flex-col justify-between p-8 sm:p-10'}`}
								>
									...
									{tier.id === 'playerevoplus' && (
										<div className="mt-4 flex items-baseline gap-x-2">
											<div className="relative">
												<video autoPlay loop playsInline muted className="-mt-4 overflow-hidden rounded-r-2xl">
							...
							<div className="flex flex-col items-start gap-x-8 gap-y-6 sm:gap-y-10 lg:col-span-2 lg:flex-row lg:items-center">
								...
								<div className="relative w-full lg:w-1/2 xl:pl-4">
									<video width="100%" autoPlay loop playsInline muted className="overflow-hidden rounded-2xl">
										<source src="/videos/go.mp4" type="video/mp4" height="240" />
										Your browser does not support the video tag.
									</video>
