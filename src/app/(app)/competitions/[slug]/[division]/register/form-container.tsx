...
export default function FormContainer({competition}: {competition: CompetitionFormContainerData}) {
    ...
    return <>
        <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 mb-12">
                <Field data-theme='light'>
                    <Label data-theme='light'>Club / Academy name</Label>
                    <Input name="club_academy" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                ...
                <Field data-theme='light'>
                    ...
                    <Input name="team_name" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                        [e.target.name]: e.target.value
                    } as unknown as FormState))} 
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <Field data-theme='light'>
                    ...
                    <Input name="first_name" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                        [e.target.name]: e.target.value
                    } as unknown as FormState))} 
                ...
                <Field data-theme='light'>
                    ...
                    <Input name="last_name" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                        [e.target.name]: e.target.value
                    } as unknown as FormState))} 
                ...
                <Field data-theme='light'>
                    ...
                    <Input type='email' name="email_address" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                        [e.target.name]: e.target.value
                    } as unknown as FormState))} 
                ...
                <Field data-theme='light'>
                    ...
                    <Input type='tel' name="phone_number" data-theme='light' onChange={e => setFormState(prev => ({
                        ...prev,
                        [e.target.name]: e.target.value
                    } as unknown as FormState))} 
                ...
                <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                        <textarea
                            ...
                            defaultValue={''} onChange={e => setFormState(prev => ({
                            ...prev,
                            [e.target.name]: e.target.value
                        } as unknown as FormState))}
                        />
                ...
                <section className='mt-8'>
                    ...
                    <CheckboxField data-theme='light'> 
                        <Checkbox color="rose" aria-required name="agree" value="yes" data-theme='light' onChange={agree => setFormState(prev => ({
                        ...prev,
                        agree,
                    } as unknown as FormState))} />
                ...
                <Button type="submit" disabled={Boolean(!formState?.agree || !formState?.team_name || !formState?.first_name || !formState?.last_name || !formState?.email_address || !formState?.phone_number)} onClick={() => {
                    toggleSubmit(true);
                }}>
                    {submitting && <svg aria-hidden="true" className="inline w-3 h-3 text-gray-200 animate-spin dark:text-gray-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
